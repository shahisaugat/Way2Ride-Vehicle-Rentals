...
import app.vehicle.design.RippleEffect;
...
public class MenuItem1 extends JButton {
    ...
    public MenuItem1(String name, int index, boolean subMenuAble) {
        super(name);
        this.index = index;
        this.subMenuAble = subMenuAble;
    ...
    public void initSubMenu(int subMenuIndex, int length) {
        ...
        setBackground(new Color(253, 106, 2)); // RGB values for #FD6A02
