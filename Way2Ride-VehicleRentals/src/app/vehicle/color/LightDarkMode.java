...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon("app/vehicle/color/light.svg"));
        buttonDark = new JButton("Dark", new FlatSVGIcon("app/vehicle/color/dark.svg"));
