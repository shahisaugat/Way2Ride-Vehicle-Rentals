package app.vehicle.sticky;

import app.vehicle.form.BillingHistory;
...
import app.vehicle.form.Dashboard;
import app.vehicle.form.TwoWheeler;
import app.vehicle.form.FourWheeler;
import app.vehicle.form.HelpSupport;
import app.vehicle.form.RewardPoints;
...
public class MainForm extends JLayeredPane {
    ...
    private void setMenuFull(boolean full) {
        ...
        menuButton.setIcon(new FlatSVGIcon("app/vehicle/logo/svg/" + icon, 0.8f));
    ...
    private class MainFormLayout implements LayoutManager {
        ...
        public void layoutContainer(Container parent) {
            synchronized (parent.getTreeLock()) {
                ...
                menuButton.setBounds(menubX, UIScale.scale(30), menuButtonWidth, menuButtonHeight + 20);
